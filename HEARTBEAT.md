...
- If any threshold is hit or crossed:
  1. Send alert to Discord `channel:1481256145426321409` (#주식-가격알림) using the message tool
  2. Include: current price, which threshold triggered, suggested action (hold / 1차 분할매도 / 2차 분할매도 / 리스크 점검)
  3. Reply HEARTBEAT_OK in DM (do NOT show the alert in DM)
